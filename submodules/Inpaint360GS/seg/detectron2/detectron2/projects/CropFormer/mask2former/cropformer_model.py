...
class CropFormer(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            # `inference_whole_views` does not consume the 2D mask logits. Keep
            # them at decoder resolution instead of allocating another full-size
            # [num_views, num_queries, height, width] tensor (about 3.62 GiB for
            # the default 5-view, 200-query, 800x1216 inference configuration).
