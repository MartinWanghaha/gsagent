...
if __name__ == '__main__':
    ...
    print("[INFO] Installing semantic RaDe-GS rasterizer...")
    os.system("pip install --no-build-isolation submodules/diff-gaussian-rasterization-semantic")
    print("[INFO] Semantic RaDe-GS rasterizer installed.")

    print("[INFO] Installing semantic Ours rasterizer...")
    os.system("pip install --no-build-isolation submodules/diff-gaussian-rasterization_ours-semantic")
    print("[INFO] Semantic Ours rasterizer installed.")

    print("[INFO] Installing SPF rasterizer (semantic Ours + stats channel)...")
    os.system("pip install --no-build-isolation submodules/diff-gaussian-rasterization-spf")
    print("[INFO] SPF rasterizer installed.")
