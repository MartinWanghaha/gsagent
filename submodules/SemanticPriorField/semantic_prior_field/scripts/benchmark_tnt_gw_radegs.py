...
if __name__ == "__main__":
    ...
    for scene_name in scenes:
        ...
        train_extract_command = " ".join(filter(None, [
            ...
            "python semantic_prior_field/scripts/train_and_extract_gw_radegs.py",
            f"-s {scene_data_dir}",
        ...
        uniform_eval_command = " ".join([
            "python semantic_prior_field/eval/TNTUniScanEvals/uniform_sampling_eval.py",
        ...
        virtual_scan_eval_command = " ".join([
            "python semantic_prior_field/eval/TNTUniScanEvals/virtual_scan_sampling_eval.py",
            f"-s {scene_data_dir}",
            "-r 2",
            "--data_device cpu",
            f"--dataset-dir {os.path.join(args.gt_dir, scene_name)}",
        ...
        legacy_eval_command = " ".join([
            "python semantic_prior_field/eval/tnt/run.py",
            f"--dataset-dir {os.path.join(args.gt_dir, scene_name)}",
            f"--traj-path {traj_path}",
            f"--ply-path {mesh_path}",
