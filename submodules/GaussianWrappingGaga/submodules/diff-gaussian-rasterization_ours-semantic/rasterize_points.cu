...
RasterizeGaussiansBackwardCUDA(
    ...
    return std::make_tuple(dL_dmeans2D, dL_dcolors, dL_dsemantic, dL_dopacity, dL_dmeans3D, dL_dcov3D, dL_dsh, dL_dsg_axis, dL_dsg_sharpness, dL_dsg_color, dL_dscales, dL_drotations);
}
